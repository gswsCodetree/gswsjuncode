...
parent.addClass('rep_table');
				...
				parent.scroll(function () {
                    ...
                    if (settings.head)
                        this.find("> tbody > tr > th").css("top", top);
            ...
            function fixHead() {
                ...
                var tr = tbody.find("> tr > th");
                var cells = tbody.find("> tr > th");
            ...
            function fixLeft() {
                ...
                var tr = table.find("> tbody > tr, > tfoot > tr");
                tr.each(function (k, row) {
            ...
            function fixRight() {
                ...
                var tr_head = table.find('> tbody').find("> tr > th");
                var tr_body = table.find('> tbody').find("> tr > th");
                var fcell = null;
...
/*  cellPos jQuery plugin
 ---------------------
 Get visual position of cell in HTML table (or its block like tbody).
...
(function ($) {
    ...
    $.fn.cellPos = function (rescan) {
        ...
        if (!pos || rescan) {
            var $table = $cell.closest("table, tbody, tbody, tfoot");
            scanTable($table);
        }
        pos = $cell.data("cellPos");
        return pos;
