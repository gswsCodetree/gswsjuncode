(function () {
    ...
    app.controller("RajakasAppStatus", ["$scope", "$state", "$log", "Ser_Services", Rajakas_CTRL]);

    function Rajakas_CTRL(scope, state, log, raj_services) {
        ...
        scope.GetStatus = function () {
            ...
            //}
                ...
                scope.dttable = false;
                var req = { AppType: "RAJAKAS", BenID: scope.ben_aadhaar };
                raj_services.POSTENCRYPTAPI("RajakasApplicationStatus", req, token, function (value) {
