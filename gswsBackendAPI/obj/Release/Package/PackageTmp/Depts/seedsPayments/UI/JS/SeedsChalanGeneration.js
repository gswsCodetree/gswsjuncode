(function () {
	...
	app.controller("SeedsChalanGenerationController", ["$scope", "$state", "$log", '$interval', "seedsPaymentsServices", 'DTOptionsBuilder', SeedsChalanGenerationController]);

	function SeedsChalanGenerationController(scope, state, log, interval, seedsPaymentsService, DTOptionsBuilder) {
