(function () {
	...
	app.controller("LayoutPlanApplicationStatus", ["$scope", "$state", "PRRD_Services", '$sce', LayoutPlanApplicationStatusCall]);

    function LayoutPlanApplicationStatusCall(scope, state,PRRD_Services, sce) {
        ...
        scope.getdetails = function () {
            ...
            PRRD_Services.POSTENCRYPTAPI("LayoutPlanApplicationStatus", objdata, token, function (value) {
                var res = value.data;
