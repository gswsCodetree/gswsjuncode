(function () {
    ...
    app.controller("NayeeBrahminsAppStatus", ["$scope", "$state", "$log", "Ser_Services", Nayee_CTRL]);

    function Nayee_CTRL(scope, state, log, nayee_services) {
        scope.pagename = "Rajaks";
        ...
        scope.GetStatus = function () {
            ...
            //}
                ...
                scope.dttable = false;
                var req = { AppType: "NAYEEBRAHMINS", BenID: scope.ben_aadhaar };
                nayee_services.POSTENCRYPTAPI("NayeeApplicationStatus", req, token, function (value) {
