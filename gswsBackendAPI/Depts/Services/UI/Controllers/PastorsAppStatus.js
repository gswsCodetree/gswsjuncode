(function () {
    ...
    app.controller("PastorsAppStatus", ["$scope", "$state", "$log", "Ser_Services", Pastors_CTRL]);

    function Pastors_CTRL(scope, state, log, pas_services) {
        ...
        scope.GetStatus = function () {
            ...
            //}
                ...
                scope.dttable = false;
                var req = { AppType: "PASTORS", BenID: scope.ben_aadhaar };
                pas_services.POSTENCRYPTAPI("PastorsApplicationStatus", req, token, function (value) {
