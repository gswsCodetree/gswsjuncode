(function () {
    ...
    app.controller("KapuNestamAppStatus", ["$scope", "$state", "$log", "Ser_Services", Kapu_CTRL]);

    function Kapu_CTRL(scope, state, log, kapu_services) {
        scope.pagename = "Kapu Nestam";
        ...
        scope.GetStatus = function () {
            ...
            //}
                ...
                scope.dttable = false;
                var req = { AppType: "KAPUNESTHAM", BenID: scope.ben_aadhaar };
                kapu_services.POSTENCRYPTAPI("KapuNestamApplicationStatus", req, token, function (value) {
