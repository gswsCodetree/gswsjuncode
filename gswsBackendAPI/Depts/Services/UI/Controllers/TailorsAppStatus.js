(function () {
    ...
    app.controller("TailorsAppStatus", ["$scope", "$state", "$log", "Ser_Services", Tailors_CTRL]);

    function Tailors_CTRL(scope, state, log, tai_services) {
        ...
        scope.GetStatus = function () {
            ...
            //}
                ...
                scope.dttable = false;
                var req = { AppType: "TAILORS", BenID: scope.ben_aadhaar };
                tai_services.POSTENCRYPTAPI("TailorsApplicationStatus", req, token, function (value) {
